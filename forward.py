...
def model_forward(
    ...
    kv_cache=None,
    start_layer=0,
    end_layer=model.module.model.config.num_hidden_layers - 1,
    extract_specific=None,
):  # hacked
    causal_mask = model.module.model._update_causal_mask(
    ...
    pos_embed = model.module.model.rotary_emb(hidden_state, pos[None, :])

    for layer_i in range(start_layer, end_layer + 1):
        hidden_state = model.module.model.layers[layer_i](
            hidden_state,
